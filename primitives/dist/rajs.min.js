...
return this.params[name];},};Params.init();var Events={events:{},on:function(eventName,callback){if(!this.events[eventName])
this.events[eventName]=[];this.events[eventName].push(callback);},fire:function(eventName,args){if(!this.events[eventName])
